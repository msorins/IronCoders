...
function printIndex($actions) {
  ...
  foreach ($actions as $action) {
    print '<li><a class="highlight" href=?WCaction=' . $action . '>'
 ...
 */
function generateChartHtml($data, $columns, $type, $options, $containerId = 'vis_div') {
  $columnsHtml = '';
