...
if (! function_exists('curl_init'))
	$WordCents_Exceptions[] = ('Google PHP API Client requires the CURL PHP extension');
if (! function_exists('json_decode'))
	$WordCents_Exceptions[] = ('Google PHP API Client requires the JSON PHP extension');
if (! function_exists('http_build_query'))
	$WordCents_Exceptions[] = ('Google PHP API Client requires http_build_query()');
...
//    die(__file__ . "109".print_r($_REQUEST, true));
