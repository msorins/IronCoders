...
mysql_query("UPDATE `phpbb_forums` SET forum_posts = forum_posts+1, forum_topics_real = forum_topics_real+1 WHERE `phpbb_forums`.`forum_id` = 14;");
  ...
  $mongoExportObj -> arhivaToNodebbTopic($arhiva_nume, "Discutii despre problema ".$arhiva_nume, 'No tags yet');

  //Update list of problems in MONGO
  $mongoExportObj -> arhivaJsonToMongo( $mongoExportObj -> arhivaToJson() );
}
