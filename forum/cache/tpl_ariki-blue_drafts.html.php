...
<div class="<?php if (! $this->_rootref['S_PRIVMSGS']) {  ?>forabg<?php } else { ?>panel<?php } ?>">
	<?php if ($this->_rootref['S_PRIVMSGS']) {  ?><div class="content"><?php } ?>


	<ul class="<?php if (! $this->_rootref['S_PRIVMSGS']) {  ?>forabg-header<?php } else { ?>cplist-header<?php } ?>">
		<li>
			<dl>
	...
	<ul class="<?php if (! $this->_rootref['S_PRIVMSGS']) {  ?>forabg-content<?php } else { ?>cplist<?php } ?>">
	...
	<?php if ($this->_rootref['S_PRIVMSGS']) {  ?></div><?php } ?>
