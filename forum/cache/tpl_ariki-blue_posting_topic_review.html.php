...
// ]]>
	...
	<?php } ?>
		...
		<div class="postbody" id="pr<?php echo $_topic_review_row_val['POST_ID']; ?>">
			...
			<?php } if ($_topic_review_row_val['U_MCP_DETAILS']) {  ?><div class="right-box"><a href="<?php echo $_topic_review_row_val['U_MCP_DETAILS']; ?>"><?php echo ((isset($this->_rootref['L_POST_DETAILS'])) ? $this->_rootref['L_POST_DETAILS'] : ((isset($user->lang['POST_DETAILS'])) ? $user->lang['POST_DETAILS'] : '{ POST_DETAILS }')); ?></a></div><?php } if ($_topic_review_row_val['POSTER_QUOTE'] && $_topic_review_row_val['DECODED_MESSAGE']) {  ?>
		...
		<?php if ($this->_rootref['S_MCP_REPORT']) {  ?>
			...
			<div class="back2top"><a href="#report" class="top"><?php echo ((isset($this->_rootref['L_BACK_TO_TOP'])) ? $this->_rootref['L_BACK_TO_TOP'] : ((isset($user->lang['BACK_TO_TOP'])) ? $user->lang['BACK_TO_TOP'] : '{ BACK_TO_TOP }')); ?></a></div>
		<?php } else { ?>

			<div class="back2top"><a href="#postingbox" class="top"><?php echo ((isset($this->_rootref['L_BACK_TO_TOP'])) ? $this->_rootref['L_BACK_TO_TOP'] : ((isset($user->lang['BACK_TO_TOP'])) ? $user->lang['BACK_TO_TOP'] : '{ BACK_TO_TOP }')); ?></a></div>
		<?php } ?>
