<?php if (!defined('IN_PHPBB')) exit; ?><div id="user-menu-c">
<div class="wrap">
	...
	<ul>
		...
		<li>
			<a class="w-icon" href="<?php echo (isset($this->_rootref['U_ACP'])) ? $this->_rootref['U_ACP'] : ''; ?>"><i class="fa fa-tachometer"></i></a>
		</li>
		<?php } if ($this->_rootref['U_MCP']) {  ?>

		<li>
			<a class="w-icon" href="<?php echo (isset($this->_rootref['U_MCP'])) ? $this->_rootref['U_MCP'] : ''; ?>"><i class="fa fa-gavel"></i></a>
		</li>
		<?php } if (! $this->_rootref['S_IS_BOT'] && $this->_rootref['S_USER_LOGGED_IN']) {  ?>

		<li>
			<a class="w-icon" href="<?php echo (isset($this->_rootref['U_PROFILE'])) ? $this->_rootref['U_PROFILE'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_PROFILE'])) ? $this->_rootref['L_PROFILE'] : ((isset($user->lang['PROFILE'])) ? $user->lang['PROFILE'] : '{ PROFILE }')); ?>" accesskey="e"><i class="fa fa-user"></i></a>
		</li>
...
<div class="wrap">
	...
	<a id="wrap"></a>
	<div id="logo">
		<a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_INDEX'])) ? $this->_rootref['L_INDEX'] : ((isset($user->lang['INDEX'])) ? $user->lang['INDEX'] : '{ INDEX }')); ?>"><?php echo (isset($this->_rootref['SITE_LOGO_IMG'])) ? $this->_rootref['SITE_LOGO_IMG'] : ''; ?></a>
