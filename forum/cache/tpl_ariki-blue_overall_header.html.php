...
<link href="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/print.css" rel="stylesheet" media="print" title="printonly" />
<link href="<?php echo (isset($this->_rootref['T_STYLESHEET_LINK'])) ? $this->_rootref['T_STYLESHEET_LINK'] : ''; ?>" rel="stylesheet" media="screen, projection" />

<?php if ($this->_rootref['S_CONTENT_DIRECTION'] == ('rtl')) {  ?>

	<link href="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/bidi.css" rel="stylesheet" media="screen, projection" />
<?php } ?>
...
<?php if ($this->_tpldata['DEFINE']['.']['CUSTOM_NAVIGATION_TYPE'] == (1)) {  $this->_tpl_include('custom_navigation_type_first.html'); } else if ($this->_tpldata['DEFINE']['.']['CUSTOM_NAVIGATION_TYPE'] == (2)) {  $this->_tpl_include('custom_navigation_type_second.html'); } else if ($this->_tpldata['DEFINE']['.']['CUSTOM_NAVIGATION_TYPE'] == (3)) {  $this->_tpl_include('custom_navigation_type_third.html'); } ?>
...
<main>
	...
	<div id="board-disabled" class="wrap">
		<strong><?php echo ((isset($this->_rootref['L_INFORMATION'])) ? $this->_rootref['L_INFORMATION'] : ((isset($user->lang['INFORMATION'])) ? $user->lang['INFORMATION'] : '{ INFORMATION }')); ?>:</strong>
		<?php echo ((isset($this->_rootref['L_BOARD_DISABLED'])) ? $this->_rootref['L_BOARD_DISABLED'] : ((isset($user->lang['BOARD_DISABLED'])) ? $user->lang['BOARD_DISABLED'] : '{ BOARD_DISABLED }')); ?>
