		...
		<div class="panel" id="qr_ns_editor_div">
			<div class="content">
				...
				<div id="message-box-ns">
					<textarea style="height: 15em;" name="message" rows="7" cols="76" tabindex="3" class="inputbox"></textarea>
				</div>
				</fieldset>
				<fieldset class="submit-buttons">
					...
					<div class="btn btn-big">
						<input type="submit" accesskey="f" tabindex="7" name="full_editor" value="<?php echo ((isset($this->_rootref['L_FULL_EDITOR'])) ? $this->_rootref['L_FULL_EDITOR'] : ((isset($user->lang['FULL_EDITOR'])) ? $user->lang['FULL_EDITOR'] : '{ FULL_EDITOR }')); ?>" />
					</div>
				</fieldset>
			</div>
		</div>
