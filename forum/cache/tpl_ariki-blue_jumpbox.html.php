...
<?php } if ($this->_rootref['S_DISPLAY_JUMPBOX']) {  ?>
	...
	<?php } ?>
			...
			</select><input type="submit" value="<?php echo ((isset($this->_rootref['L_GO'])) ? $this->_rootref['L_GO'] : ((isset($user->lang['GO'])) ? $user->lang['GO'] : '{ GO }')); ?>" />
		</fieldset>
	</form>
	<div class="clear"></div>
<?php } ?>