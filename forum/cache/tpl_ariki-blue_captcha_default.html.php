...
<?php } ?>
	...
	<dl>
		...
		<div class="btn btn-normal">
			<input type="submit" name="refresh_vc" id="refresh_vc" value="<?php echo ((isset($this->_rootref['L_VC_REFRESH'])) ? $this->_rootref['L_VC_REFRESH'] : ((isset($user->lang['VC_REFRESH'])) ? $user->lang['VC_REFRESH'] : '{ VC_REFRESH }')); ?>" />
		</div>
		<?php } ?>
