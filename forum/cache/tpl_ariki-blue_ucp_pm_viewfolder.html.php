...
<?php } else { if ($this->_rootref['NUM_REMOVED']) {  ?>
	...
	<fieldset class="display-actions">
		...
		<div class="mark-unmark"><a href="#" onclick="marklist('viewfolder', 'marked_msg', true); return false;"><?php echo ((isset($this->_rootref['L_MARK_ALL'])) ? $this->_rootref['L_MARK_ALL'] : ((isset($user->lang['MARK_ALL'])) ? $user->lang['MARK_ALL'] : '{ MARK_ALL }')); ?></a><a href="#" onclick="marklist('viewfolder', 'marked_msg', false); return false;"><?php echo ((isset($this->_rootref['L_UNMARK_ALL'])) ? $this->_rootref['L_UNMARK_ALL'] : ((isset($user->lang['UNMARK_ALL'])) ? $user->lang['UNMARK_ALL'] : '{ UNMARK_ALL }')); ?></a></div>
	</fieldset>

	<div class="actions">
	<div class="pagination">
		<?php if ($this->_rootref['TOTAL_MESSAGES'] || $this->_rootref['S_VIEW_MESSAGE']) {  if ($this->_rootref['TOTAL_MESSAGES']) {  ?>
