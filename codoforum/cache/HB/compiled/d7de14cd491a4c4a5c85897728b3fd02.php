...
' : '').'        </div>
        ...
        <div class="codo_topics_topic_content">
            ...
            <div class="codo_topics_topic_name">
                <a href="'.$cx['funcs']['ch']($cx, 'const', array(array('RURI'),array()), 'raw').'user/profile/'.((isset($in['id']) && is_array($in)) ? $in['id'] : null).'">'.htmlentities((string)((isset($in['name']) && is_array($in)) ? $in['name'] : null), ENT_QUOTES, 'UTF-8').'</a>
...
'.(($cx['funcs']['ifvar']($cx, ((isset($in['in_search']) && is_array($in)) ? $in['in_search'] : null))) ? '            <div class="codo_topics_topic_title"><a id="codo_topic_link_'.htmlentities((string)((isset($in['topic_id']) && is_array($in)) ? $in['topic_id'] : null), ENT_QUOTES, 'UTF-8').'" href="'.$cx['funcs']['ch']($cx, 'const', array(array('RURI'),array()), 'raw').'topic/'.htmlentities((string)((isset($in['topic_id']) && is_array($in)) ? $in['topic_id'] : null), ENT_QUOTES, 'UTF-8').'/'.htmlentities((string)((isset($in['safe_title']) && is_array($in)) ? $in['safe_title'] : null), ENT_QUOTES, 'UTF-8').'/post-'.htmlentities((string)((isset($in['post_id']) && is_array($in)) ? $in['post_id'] : null), ENT_QUOTES, 'UTF-8').'#post-'.htmlentities((string)((isset($in['post_id']) && is_array($in)) ? $in['post_id'] : null), ENT_QUOTES, 'UTF-8').'">'.((isset($in['title']) && is_array($in)) ? $in['title'] : null).'</a></div>                                    
' : ''.(($cx['funcs']['ifvar']($cx, ((isset($in['new_replies']) && is_array($in)) ? $in['new_replies'] : null))) ? '            <div class="codo_topics_topic_title"><a id="codo_topic_link_'.htmlentities((string)((isset($in['topic_id']) && is_array($in)) ? $in['topic_id'] : null), ENT_QUOTES, 'UTF-8').'" href="'.$cx['funcs']['ch']($cx, 'const', array(array('RURI'),array()), 'raw').'topic/'.htmlentities((string)((isset($in['topic_id']) && is_array($in)) ? $in['topic_id'] : null), ENT_QUOTES, 'UTF-8').'/'.htmlentities((string)((isset($in['safe_title']) && is_array($in)) ? $in['safe_title'] : null), ENT_QUOTES, 'UTF-8').'/post-'.htmlentities((string)((isset($in['last_reply_id']) && is_array($in)) ? $in['last_reply_id'] : null), ENT_QUOTES, 'UTF-8').'#post-'.htmlentities((string)((isset($in['last_reply_id']) && is_array($in)) ? $in['last_reply_id'] : null), ENT_QUOTES, 'UTF-8').'">'.((isset($in['title']) && is_array($in)) ? $in['title'] : null).'</a></div>
' : '            <div class="codo_topics_topic_title"><a id="codo_topic_link_'.htmlentities((string)((isset($in['topic_id']) && is_array($in)) ? $in['topic_id'] : null), ENT_QUOTES, 'UTF-8').'" href="'.$cx['funcs']['ch']($cx, 'const', array(array('RURI'),array()), 'raw').'topic/'.htmlentities((string)((isset($in['topic_id']) && is_array($in)) ? $in['topic_id'] : null), ENT_QUOTES, 'UTF-8').'/'.htmlentities((string)((isset($in['safe_title']) && is_array($in)) ? $in['safe_title'] : null), ENT_QUOTES, 'UTF-8').'">'.((isset($in['title']) && is_array($in)) ? $in['title'] : null).'</a></div>                                        
').'').'
        </div>
...
'.(($cx['funcs']['ifvar']($cx, ((isset($in['can_manage_topic']) && is_array($in)) ? $in['can_manage_topic'] : null))) ? '                <input type="checkbox" id="codo_posts_select_'.((isset($in['topic_id']) && is_array($in)) ? $in['topic_id'] : null).'" class="codo_posts_select_post"/>
' : '').''.(($cx['funcs']['ifvar']($cx, ((isset($in['overflow']) && is_array($in)) ? $in['overflow'] : null))) ? '
                <a href="'.$cx['funcs']['ch']($cx, 'const', array(array('RURI'),array()), 'raw').'topic/'.htmlentities((string)((isset($in['topic_id']) && is_array($in)) ? $in['topic_id'] : null), ENT_QUOTES, 'UTF-8').'/'.htmlentities((string)((isset($in['safe_title']) && is_array($in)) ? $in['safe_title'] : null), ENT_QUOTES, 'UTF-8').'" rel="nofollow" class="codo_readmore">'.$cx['funcs']['ch']($cx, 'i18n', array(array('read more'),array()), 'encq').'</a>
' : '').'            </div>
...
' : '').'            </div>
        ...
        <div class="codo_topics_topic_foot clearfix">
            ...
            <div class="codo_topics_no_replies" id="codo_topics_no_views"><span>'.htmlentities((string)((isset($in['no_views']) && is_array($in)) ? $in['no_views'] : null), ENT_QUOTES, 'UTF-8').'</span>'.$cx['funcs']['ch']($cx, 'i18n', array(array('views'),array()), 'raw').'</div>
'.(($cx['funcs']['ifvar']($cx, ((isset($in['last_post_time']) && is_array($in)) ? $in['last_post_time'] : null))) ? '            <div class="codo_topics_last_post">
                ...
                &nbsp;&middot;&nbsp; <span class=\'codo_topics_last_post_time\'><a href="'.$cx['funcs']['ch']($cx, 'const', array(array('RURI'),array()), 'raw').'topic/'.htmlentities((string)((isset($in['topic_id']) && is_array($in)) ? $in['topic_id'] : null), ENT_QUOTES, 'UTF-8').'/'.htmlentities((string)((isset($in['safe_title']) && is_array($in)) ? $in['safe_title'] : null), ENT_QUOTES, 'UTF-8').'/post-'.htmlentities((string)((isset($in['last_post_id']) && is_array($in)) ? $in['last_post_id'] : null), ENT_QUOTES, 'UTF-8').'#post-'.htmlentities((string)((isset($in['last_post_id']) && is_array($in)) ? $in['last_post_id'] : null), ENT_QUOTES, 'UTF-8').'">'.htmlentities((string)((isset($in['last_post_time']) && is_array($in)) ? $in['last_post_time'] : null), ENT_QUOTES, 'UTF-8').'</a></span>
            </div>
' : '').'        </div>
